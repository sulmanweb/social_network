        ...
        <div class="jumbotron">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control input-lg"
                     id="signup-password-confirmation" placeholder="Confirm Password*" required
                     name="password_confirmation"
                     v-model="form_data.password_confirmation">
            </div>
            <button type="submit" class="btn btn-default btn-lg btn-block"
                    @click.prevent="submitSignUp"><i class="fas fa-sign-in-alt"></i> Sign Up
            </button>
            <div class="text-center">
              <router-link class="btn btn-default btn-sm" :to="{name: 'SignIn'}">SignIn</router-link>
            </div>
          </form>
        </div>
      </div>
